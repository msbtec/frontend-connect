                            ...
                            <Col sm="6">
                                <h4 className="page-title">Material Design</h4>
                                    <Breadcrumb>
                                        ...
                                        <BreadcrumbItem active>Material Design</BreadcrumbItem>
                                    </Breadcrumb>
                            </Col>
                            <Col sm="6">
                        ...
                        <Col>
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="text-muted m-b-30">Use
                                        <code>&lt;i class="mdi mdi-turtle"&gt;&lt;/i&gt;</code>
                                        <span className="badge badge-success h6">v3.2.89</span>.
                                    </p>
