            ...
            <Card>
              <CardBody>
                ...
                <div className="button-items">
                  ...
                  <Button color="primary" id="TooltipTop">
                    {' '}
                    Tooltip on top
                  </Button>{' '}
                  <Button color="primary" id="TooltipRight">
                    {' '}
                    Tooltip on right
                  </Button>{' '}
                  <Button color="primary" id="TooltipBottom">
                    {' '}
                    Tooltip on bottom
                  </Button>{' '}
                  <Button color="primary" id="TooltipLeft">
                    {' '}
                    Tooltip on left
                  </Button>
                </div>
              ...
              <CardBody>
                ...
                <Row>
                  <Col lg="6">
                    ...
                    <p className="text-muted m-b-30">
                      Fancy larger or smaller pagination? Add size ={' '}
            ...
            <Card>
              <CardBody>
                ...
                <div>
                  ...
                  <Spinner color="success" /> <Spinner color="info" />{' '}
                  <Spinner color="warning" /> <Spinner color="danger" />{' '}
                  <Spinner color="dark" />
                </div>
              </CardBody>
            </Card>
