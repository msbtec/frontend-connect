...
function Buttons() {
  ...
  const [drp_link, setDrpLink] = useState([]);
            ...
            <Card>
              <CardBody>
                ...
                <div className="button-items">
                  ...
                  <Button type="button" color="link" className="waves-effect">
                    Link
                  </Button>{' '}
                  <Button type="button" color="light" className="waves-effect">
                    Light
                  </Button>
                </div>
              </CardBody>
          ...
          <Col lg="6">
            <Card>
              <CardBody>
                ...
                <p className="text-muted m-b-20">
                  Replace the default properties of react{' '}
            ...
            <Card>
              <CardBody>
                ...
                <p className="text-muted m-b-20 ">
                  ...
                  element. However, you can also use these class on{' '}
            ...
            <Card>
              <CardBody>
                ...
                <p className="text-muted m-b-20">
                  ...
                  <code className="highlighter-rouge">lg</code> or{' '}
                  <code className="highlighter-rouge">sm</code> for additional
                  sizes.
                </p>
                <div className="button-items">
                  <Button
            ...
            <Card>
              <CardBody>
                ...
                <p className="text-muted m-b-20 ">
                  ...
                  the <code className="highlighter-rouge">.active </code>{' '}
                  className
                  <strong> and</strong>{' '}
            ...
            <Card>
              <CardBody>
                ...
                <p className="text-muted m-b-30 ">
                  ...
                  <code className="highlighter-rouge">Button</code> in{' '}
                  <code className="highlighter-rouge">ButtonGroup</code>.
                </p>
                <ButtonGroup>
          ...
          <Col lg="6">
            <Card>
              <CardBody>
                ...
                <p className="text-muted m-b-30 ">
                  Combine sets of button groups into ButtonToolbar for more
                  complex components. Use utility class as needed to space out
          ...
          <Col lg="6">
            <Card>
              <CardBody>
                ...
                <p className="text-muted m-b-30 ">
                  Instead of applying button sizing className to every button in
                  a group, just add{' '}
                  <code className="highlighter-rouge">ButtonGroup</code> to each{' '}
                  <code className="highlighter-rouge">ButtonGroup</code>,
