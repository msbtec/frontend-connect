      ...
      <Container fluid>
        ...
        <Row>
          <Col xl="3" md="6">
            <Card>
              <CardBody>
                <div className="color-box bg-primary">#626ed4</div>
          ...
          <Col xl="3" md="6">
            <Card>
              <CardBody>
                <div className="color-box bg-success">#02a499</div>
          ...
          <Col xl="3" md="6">
            <Card>
              <CardBody>
                <div className="color-box bg-info">#38a4f8</div>
          ...
          <Col xl="3" md="6">
            <Card>
              <CardBody>
                <div className="color-box bg-warning">#f8b425</div>
        ...
        <Row>
          <Col xl="3" md="6">
            <Card>
              <CardBody>
                <div className="color-box bg-danger">#ec4561</div>
          ...
          <Col xl="3" md="6">
            <Card>
              <CardBody>
                <div className="color-box bg-dark">#343a40</div>
          ...
          <Col xl="3" md="6">
            <Card>
              <CardBody>
                <div className="color-box bg-muted">#9ca8b3</div>
                <h5 className="mb-0 m-t-20 text-muted text-center font-18">
                  Muted
                </h5>
              </CardBody>
            </Card>
