...
import api_connect from '~/services/connect-service';
...
export default function DetailUser() {
  ...
  useEffect(() => {
    Promise.all([
      api_user.get(`/users/${cpf}`),
      api_connect.get(`/worker/${cpf}`),
    ]).then((response) => {
          ...
          <Card>
            <CardBody>
              ...
              <p className="text-muted m-b-30 ">
                Easy to use React validation components compatible for
                reactstrap
              </p>
        ...
        <Col lg="6">
          <Card>
            <CardBody>
              ...
              <p className="text-muted m-b-30 ">
                Easy to use React validation components compatible for
                reactstrap.The polyfill can be applied into your web application
                by using tools like Webpack or Babel.
              </p>
