                ...
                <Table responsive className="table-editable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <Editable dataType="text" mode="inline" value="1.99" />
                      </td>
                    </tr>
                    <tr>
                      <td>2</td>
                      ...
                      <td>
                        <Editable dataType="text" mode="inline" value="2.99" />
                      </td>
                    </tr>
                    <tr>
                      <td>3</td>
                      ...
                      <td>
                        <Editable dataType="text" mode="inline" value="3.99" />
                      </td>
                    </tr>
                    <tr>
                      <td>4</td>
                      ...
                      <td>
                        <Editable dataType="text" mode="inline" value="4.99" />
                      </td>
                    </tr>
                    <tr>
                      <td>5</td>
                      ...
                      <td>
                        <Editable dataType="text" mode="inline" value="5.99" />
                      </td>
                    </tr>
                  </tbody>
                </Table>
