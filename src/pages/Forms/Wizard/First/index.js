...
const WizardFormFirstPage = (props) => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      <h6 className="p-1 m-3 d-block">1. &nbsp;Seller Details</h6>
      <br />
      <FormGroup tag="fieldset" className="text-right">
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtFirstNameBilling" lg="3">
                Contact Person
              </Label>
              <Col lg="9">
                <Input
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtLastNameBilling" lg="3">
                Mobile No.
              </Label>
              <Col lg="9">
                <Input
        ...
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtCompanyBilling" lg="3">
                Landline No.
              </Label>
              <Col lg="9">
                <Input
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtEmailAddressBilling" lg="3">
                Email Address
              </Label>
              <Col lg="9">
                <Input
        ...
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtAddress1Billing" lg="3">
                Address 1
              </Label>
              <Col lg="9">
                <Input
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtAddress2Billing" lg="3">
                Warehouse Address
              </Label>
              <Col lg="9">
                <Input
        ...
        <Row>
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtStateProvinceBilling" lg="3">
                Live Market A/C
              </Label>
              <Col lg="9">
                <Input
        ...
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtTelephoneBilling" lg="3">
                Product Category
              </Label>
              <Col lg="9">
                <Input
