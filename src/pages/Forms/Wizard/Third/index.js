...
const WizardFormThirdPage = (props) => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      <h6 className="p-1 m-3 d-block">3. &nbsp;Bank Details</h6>
      <br />
      <FormGroup tag="fieldset" className="text-right">
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtNameCard" lg="3">
                Name on Card
              </Label>
              <Col lg="9">
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="ddlCreditCardType" lg="3">
                Credit Card Type
              </Label>
              <Col lg="9">
                <Input
        ...
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtCreditCardNumber" lg="3">
                Credit Card Number
              </Label>
              <Col lg="9">
                <Input
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtCardVerificationNumber" lg="3">
        ...
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtExpirationDate" lg="3">
                Expiration Date
              </Label>
              <Col lg="9">
                <Input
