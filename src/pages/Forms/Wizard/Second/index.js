...
const WizardFormSecondPage = (props) => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      <h6 className="p-1 m-3 d-block">2. &nbsp;Company Document</h6>
      <br />
      <FormGroup tag="fieldset" className="text-right">
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtFirstNameShipping" lg="3">
                PAN Card
              </Label>
              <Col lg="9">
                <Input
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtLastNameShipping" lg="3">
                VAT/TIN No.
              </Label>
              <Col lg="9">
                <Input
        ...
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtCompanyShipping" lg="3">
                CST No.
              </Label>
              <Col lg="9">
                <Input
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtEmailAddressShipping" lg="3">
                Service Tax No.
              </Label>
              <Col lg="9">
                <Input
        ...
        <Row>
          <Col md="6">
            <FormGroup row>
              <Label for="txtCityShipping" lg="3">
                Company UIN
              </Label>
              <Col lg="9">
                <Input
          ...
          <Col md="6">
            <FormGroup row>
              <Label for="txtStateProvinceShipping" lg="3">
                Declaration
              </Label>
              <Col lg="9">
                <Input
      ...
      <div id="btn_div" className="float-right">
        <Button type="button" color="primary" onClick={previousPage}>
          {' '}
          Previous{' '}
        </Button>{' '}
        &nbsp;&nbsp;&nbsp;
