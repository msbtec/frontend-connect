            ...
            <Card>
              <CardBody>
                ...
                <Form>
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-search-input" sm="2">
                      Search
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-email-input" sm="2">
                      Email
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-url-input" sm="2">
                      URL
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-tel-input" sm="2">
                      Telephone
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-password-input" sm="2">
                      Password
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-number-input" sm="2">
                      Number
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-datetime-local-input" sm="2">
                      Date and time
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-date-input" sm="2">
                      Date
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-month-input" sm="2">
                      Month
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-week-input" sm="2">
                      Week
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-time-input" sm="2">
                      Time
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-color-input" sm="2">
                      Color
                    </Label>
                    <Col sm="10">
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-text-input-lg" sm="2">
                      Large
                    </Label>
                    <Col sm="10">
                      <Input
                  ...
                  <FormGroup row>
                    <Label htmlFor="example-text-input-sm" sm="2">
                      Small
                    </Label>
                    <Col sm="10">
                      <Input
