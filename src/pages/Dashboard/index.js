...
import img4 from '~/assets/images/services-icon/04.png';
...
import RadialChart from '~/components/Charts/Apex/donut';
import Apexdonut from '~/components/Charts/Apex/donut1';
import LineAreaChart from '~/components/Charts/Apex/linearea';
import Salesdonut from '~/components/Charts/Apex/sales';
import SparkLine from '~/components/Charts/Sparkline/sparkline';
import SparkLine1 from '~/components/Charts/Sparkline/sparkline1';
            ...
            <CardBody>
              ...
              <div className="cleafix">
                <p className="float-left">
                  <i className="mdi mdi-calendar mr-1 text-primary" /> Jan 01 -
                  Jan 31
                </p>
              ...
              <Card className="bg-primary">
                <CardBody>
                  <div className="text-center text-white py-4">
                    <h5 className="mt-0 mb-4 text-white-50 font-16">
                      Top Product Sale
                    </h5>
                    <h1>1452</h1>
                    <p>Computer</p>
