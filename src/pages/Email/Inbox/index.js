          ...
          <Col md="12">
            ...
            <div className="email-rightbar mb-3">
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk19" className="toggle" />
                      </div>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk20" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        me, Susanna (7)
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk6" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Web Support Dennis
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk7" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        me, Peter (2)
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk8" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Medium
                      </Link>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        <span className="badge-primary badge mr-2">Social</span>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk9" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Death to Stock
                      </Link>
                  ...
                  <li className="unread">
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk3" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Randy, me (5)
                      </Link>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        <span className="badge-success badge mr-2">Family</span>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk4" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Andrew Zimmer
                      </Link>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        ...
                        <span className="teaser">
                          {' '}
                          You've been confirmed! Welcome to the ruling className
                          of the inbox. For your records, here is a copy of the
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk5" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Infinity HR
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk10" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Revibe
                      </Link>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        <span className="badge-danger badge mr-2">Friends</span>
                        Weekend on Revibe –
                        <span className="teaser">
                          {' '}
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk11" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Erik, me (5)
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk13" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Tobias Berggren
                      </Link>
                  ...
                  <li className="unread">
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk15" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        me, Peter (5)
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk16" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Stack Exchange
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk17" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        Google Drive Team
                      </Link>
                  ...
                  <li>
                    <div className="col-mail col-mail-1">
                      <div className="checkbox-wrapper-mail">
                        ...
                        <Label for="chk18" className="toggle" />
                      </div>
                      <Link to="#" className="title">
                        me, Susanna (11)
                      </Link>
              ...
              <Row className="m-t-20">
                <Col md="7">Showing 1 - 20 of 1,524</Col>
                <Col md="5">
